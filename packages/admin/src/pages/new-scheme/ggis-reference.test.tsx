  ...
  describe('getServerSideProps', () => {
    ...
    describe('when handling a GET request', () => {
      ...
      it('Returns a default backButtonHref value when a property for it is NOT passed in', async () => {
        ...
        expect(value.props.backButtonHref).toStrictEqual('/new-scheme/name');
      });
      ...
      it('Returns a default formAction', async () => {
        ...
        expect(value.props.formAction).toStrictEqual(
          '/apply/new-scheme/ggis-reference?backButtonHref=/new-scheme/name&successRedirect=/new-scheme/email'
        );
      });
      ...
      it('Returns a correct formAction value when back & success redirects are passed in', async () => {
        ...
        expect(value.props.formAction).toStrictEqual(
          '/apply/new-scheme/ggis-reference?backButtonHref=/testBack&successRedirect=/testRedirect'
        );
      });
    ...
    describe('when handling a POST request', () => {
      ...
      describe('Validation errors', () => {
        const fieldErrors = [
          {
            ...
            errorMessage: 'GGIS Reference is required',
          },
        ];
        ...
        it('Should return the previously inputted ggis reference when adding to the session throws validation errors', async () => {
          const value = (await getServerSideProps(
            getPostContext()
          )) as NextGetServerSidePropsResponse;

          expect(value.props.defaultValue).toStrictEqual('testGGISReference');
        });
      });
    });
  });

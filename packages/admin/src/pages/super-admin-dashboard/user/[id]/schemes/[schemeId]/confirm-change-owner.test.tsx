  ...
  describe('UI', () => {
    ...
    it('Should render a back button', () => {
      ...
      expect(screen.getByRole('link', { name: 'Back' })).toHaveAttribute(
        'href',
        '/apply/admin/super-admin-dashboard/user/testUserId/schemes/testSchemeId/change-owner?oldEmailAddress=oldEmail%40test.com&newEmailAddress=newEmail%40test.com&schemeName=Test+Scheme'
      );
    });
